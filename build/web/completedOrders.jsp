<%-- 
    ...
    Created on : Jan 26, 2022, 9:41:27 PM
    Author     : KIM DUONG
--%>
    ...
    <body>
        ...
        <section> 
            <%
                ...
                ArrayList<Order> list = OrderDAO.getOrdersStatus(email, 2);
            ...
            <table class="table" style="border-color: black">
                ...
                <tr><td class="details" style='text-align: center'><%= ord.getOrderID()%></td>
                    ...
                    <td class="details" style = 'color: green; text-align: center'><%= "Completed"%>
            ...
            %>
            <div style="text-align: center; font-size: 30px; margin-top: 100px; margin-bottom: 100px;">You don't have any completed order!</div>
            <% } %>
