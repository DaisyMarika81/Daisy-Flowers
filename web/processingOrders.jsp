<%-- 
    ...
    Created on : Jan 26, 2022, 9:41:46 PM
    Author     : KIM DUONG
--%>
    ...
    <body>
        ...
        <section> 
            <%
                ...
                ArrayList<Order> list = OrderDAO.getOrdersStatus(email, 1);
            ...
            <table class="table" style="border-color: black">
                ...
                <tr><td class="details" style='text-align: center'><%= ord.getOrderID()%></td>
                    ...
                    <td class="details" style = 'color: #039dfc; text-align: center'><%= "Processing"%>
                        <br/><a href="mainController?action=cancelorder" style = 'color: red; text-align: center'>Cancel order</a>
                    </td>
            ...
            %>
            <div style="text-align: center; font-size: 30px; margin-top: 100px; margin-bottom: 100px;">You don't have any processing order!</div>
            <% }%>          
        </section>
        <footer>
